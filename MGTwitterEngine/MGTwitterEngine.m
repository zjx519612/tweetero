...
+ (NSString *)password
{
	...
	{
#if !TARGET_IPHONE_SIMULATOR
		NSMutableDictionary *passwordQuery = createBaseDictionary(@"twitter.com", _username);
...
#if !TARGET_IPHONE_SIMULATOR		
		NSMutableDictionary *passwordEntry = createBaseDictionary(@"twitter.com", _username);
